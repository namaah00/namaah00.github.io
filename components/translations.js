...
export const translations = {
  pl: {
    ...
    sourceDialogAccessDateLabel: 'Data dostępu',
    sourceDialogAccessDatePlaceholder: 'np. 2025-04-07',
    sourceDialogAccessLinkLabel: 'Link dostępu',
    sourceDialogAccessLinkPlaceholder: 'https://example.com/article',
    sourceDialogCharacterLabel: 'Charakter źródła',
    sourceDialogCharacterPlaceholder: 'Wybierz charakter źródła',
    sourceDialogStatusLabel: 'Status',
    sourceDialogStatusPlaceholder: 'Wybierz status źródła',
    sourceDialogCancel: 'Anuluj',
    sourceDialogAdd: 'Dodaj',
    
    //opcje charakteru źródła
    sourceCharacterOfficial1: 'oficjalne – rządowe',
    sourceCharacterOfficial2: 'oficjalne – instytucjonalne',
    sourceCharacterMedia1: 'media – głównego nurtu',
    sourceCharacterMedia2: 'media – niszowe / branżowe',
    sourceCharacterMedia3: 'media – tabloidalne',
    sourceCharacterSocial: 'platforma społecznościowa',
    sourceCharacterAnonymous: 'źródło anonimowe',
    sourceCharacterPrimary: 'źródło pierwotne',
    sourceCharacterScientific: 'publikacja naukowa',
    sourceCharacterOther: 'inne',
    
    //opcje statusu źródła
    sourceStatusOfficial: 'oficjalne stanowisko',
    sourceStatusJournalistic: 'relacja dziennikarska',
    sourceStatusOpinion: 'opinia / komentarz',
    sourceStatusUnofficial: 'informacja nieoficjalna',
    sourceStatusStatistical: 'dane statystyczne/raporty',
    ...
    pdfSourceAccessDate: 'Data dostępu',
    pdfSourceLink: 'Link',
    pdfSourceCharacter: 'Charakter',
    pdfSourceStatus: 'Status',
  ...
  en: {
    ...
    sourceDialogAccessDateLabel: 'Access Date',
    sourceDialogAccessDatePlaceholder: 'e.g. 2025-04-07',
    sourceDialogAccessLinkLabel: 'Access Link',
    sourceDialogAccessLinkPlaceholder: 'https://example.com/article',
    sourceDialogCharacterLabel: 'Source Character',
    sourceDialogCharacterPlaceholder: 'Select source character',
    sourceDialogStatusLabel: 'Status',
    sourceDialogStatusPlaceholder: 'Select source status',
    sourceDialogCancel: 'Cancel',
    sourceDialogAdd: 'Add Source',
    
    //opcje charakteru źródła
    sourceCharacterOfficial1: 'official – governmental',
    sourceCharacterOfficial2: 'official – institutional',
    sourceCharacterMedia1: 'media – mainstream',
    sourceCharacterMedia2: 'media – niche / industry',
    sourceCharacterMedia3: 'media – tabloid',
    sourceCharacterSocial: 'social media platform',
    sourceCharacterAnonymous: 'anonymous source',
    sourceCharacterPrimary: 'primary source',
    sourceCharacterScientific: 'scientific publication',
    sourceCharacterOther: 'other',
    
    //opcje statusu źródła
    sourceStatusOfficial: 'official statement',
    sourceStatusJournalistic: 'journalistic report',
    sourceStatusOpinion: 'opinion / commentary',
    sourceStatusUnofficial: 'unofficial information',
    sourceStatusStatistical: 'statistical data/reports',
    ...
    pdfSourceAccessDate: 'Access Date',
    pdfSourceLink: 'Link',
    pdfSourceCharacter: 'Character',
    pdfSourceStatus: 'Status',
